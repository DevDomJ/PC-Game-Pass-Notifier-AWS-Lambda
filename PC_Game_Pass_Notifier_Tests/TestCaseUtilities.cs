...
Duis au";
		...
		public static string LoremIpsum(int characterNumber)
		{
			...
			{
				int repetitions = characterNumber % s_loremIpsum.Length;
				int charactersLeft = characterNumber - repetitions * s_loremIpsum.Length;
				StringBuilder stringBuilder = new();
				for (int i = 0; i < repetitions; i++)
				{
					stringBuilder.Append(s_loremIpsum);
				}
				if (charactersLeft > 0)
				{
