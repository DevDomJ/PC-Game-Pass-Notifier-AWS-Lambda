...
namespace PC_Game_Pass_Notifier_AWS_Lambda
{
	public class GamePassGame
	{
		...
		public string AsUpdateEmbed()
		{
			...
			// TODO: Ensure description does not exceed footer text limit of 2048 characters
			Dictionary<string, string> footerObject = new();
			footerObject.Add("text", ShortDescription);
			...
			embedObject.Add("footer", JsonConvert.SerializeObject(footerObject));
